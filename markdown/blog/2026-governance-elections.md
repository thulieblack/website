...
date: 2026-07-03T06:00:00+01:00
type: Communication
tags:
  - Project Status
...
authors:
  - name: Hugo Guerrero
    photo: /img/avatars/hugo.webp
    link: https://www.linkedin.com/in/hugoguerrero
    byline: Head of Technical Marketing
...
As we welcome new perspectives to the Governance Board, we want to take a moment to honour [Fran Mendez](https://www.linkedin.com/in/fmvilas), who recently stepped down from his role as Governance Board member.
...
The governance structures, community policies, and inclusive practices that we celebrate today are built on the foundation Fran helped establish. His commitment to transparent, community-driven governance has set the tone for how we make decisions and involve our members.
...
### Eligibility
You are eligible to vote if you are listed as a TSC member in the AsyncAPI community. You can verify your status by checking the [MAINTAINERS.yaml](https://github.com/asyncapi/community/blob/master/MAINTAINERS.yaml) and [AMBASSADORS_MEMBERS.yaml](https://github.com/asyncapi/community/blob/master/AMBASSADORS_MEMBERS.yaml) files in the AsyncAPI community repository (look for `isTSCMember: true`). You can also see the full list of TSC members on the [AsyncAPI Website](https://asyncapi.com/community/tsc).
...
For more detailed information about the governance process, see the [AsyncAPI Governance guidelines](https://github.com/asyncapi/community/blob/master/docs/020-governance-and-policies/GOVERNANCE.md#voting).
...
<Profiles profiles={[
{
    ...
    avatar: '/img/posts/governance-elections/Aayush.webp',
    link: 'https://github.com/asyncapi/community/blob/MAINTAINERS.yaml#L25'
}
]} />
...
{
    name: "Entitled to candidacy as a maintainer",
    avatar: '/img/posts/governance-elections/Maya.webp',
    link: 'https://github.com/asyncapi/community/blob/master/MAINTAINERS.yaml#L1'
}
]} />
...
{
    name: "Entitled to candidacy as a maintainer",
    avatar: '/img/posts/governance-elections/Azeez.webp',
    link: 'https://github.com/asyncapi/community/blob/master/MAINTAINERS.yaml#L259'
}
]} />
