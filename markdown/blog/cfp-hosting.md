...
// so here Architecture Of The platform
Back end
Front end
Netlify
...
- github actions
- cfp agenda/ details every 7 days
...
// dont worry about following this exact outline or doing any grammar or structure I'll use my docs knowledge for story telling :)